...
export function SectorStatusIndicator({ isOpen, size = 96 }: Props) {
  const r = size / 2
    ...
    >
      ...
      >
        <defs>
          ...
          <linearGradient id={`sector-water-grad-${size}`} x1="0" y1="1" x2="0" y2="0">
          ...
          <linearGradient id={`sector-water-wave1-${size}`} x1="0" y1="1" x2="0" y2="0">
        ...
        <g clipPath={`url(#sector-clip-${size})`}>
          {/* Main water body — animated via CSS keyframes */}
          <rect
            x="0"
            width={size}
            height={size * 1.2}
            fill={`url(#sector-water-grad-${size})`}
          ...
          {isOpen && (
            <rect
              ...
              width={size * 1.5}
              height={size * 1.2}
              fill={`url(#sector-water-wave1-${size})`}
          ...
          {isOpen && (
            <>
              <circle
                ...
                fill="white"
                fillOpacity="0.4"
                className="animate-sector-bubble"
              />
              <circle
                cx={size * 0.55}
                cy={size * 0.75}
                ...
                fill="white"
                fillOpacity="0.3"
                className="animate-sector-bubble-delayed"
              />
              <circle
                cx={size * 0.7}
                cy={size * 0.6}
                ...
                fill="white"
                fillOpacity="0.35"
                className="animate-sector-bubble-slow"
              />
            </>
          )}
        </g>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        />
        <span
          className={`text-[10px] font-bold mt-0.5 transition-colors duration-500 ${
